...
You said:
Okay, in the below code, I have a Streamlit dashboard that is plotting two different datasets. Right now, the filtering is independent between the two. 

But you can see the merged_tf dataframe that merges the two datasets. 

I am looking to create a third row, with the same visualizations as the first two rows, but using the joint dataframe such that I can apply the hourly and three hourly filters at once and see the combined statistics.
